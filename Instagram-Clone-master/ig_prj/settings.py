...
CRISPY_TEMPLATE_PACK = 'bootstrap4'
LOGIN_URL = 'sign-in'  # The URL where requests are redirected for login
LOGIN_REDIRECT_URL = 'index'  # The URL where requests are redirected after login
LOGOUT_REDIRECT_URL = 'sign-in'  # The URL where requests are redirected after logout
